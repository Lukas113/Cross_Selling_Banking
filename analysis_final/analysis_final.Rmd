...
accounts_services_1year_before_card_loan %>%
  ...
  scale_x_continuous(breaks = c(-365, 0, 365, 365*2, 365*3, 365*4, 365*5 ),
                     labels = c("-1y", "Karte ausgestellt", "1y", "2y", "3y", "4y", "5y") ) +
  xlab("Tage vor und nach Ausstellung Karte") +
  labs(title = "Dienstleistungen vor und nach Ausstellung der Kreditkarte", 
...
x- S: Loan Altersverteiung Timeframe, Alter zu Loan Ausstelldatum
