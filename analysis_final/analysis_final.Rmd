...
Untersucht wurde, ob eine Korrelation zwischen dem Alter und dem Durchschnittlichen Vermögen besteht. Der Korrelationskoeffizient beträgt `r cor`, womit eine stark negative Korrelation besteht. Das bedeutet, dass mit zunehmendem Alter das Vermögen abnimmt.
...
>>>>>>> f6044876f260caf32e489671f61adcebc56c2a81
```
...
ggplot() +
  geom_freqpoly(data = data_client_age_by_issued_date, mapping = aes(x = age_on_card_issue), binwidth=2, color="blue") +
  geom_freqpoly(data = data_clients_without_credit_card_0_100, mapping = aes(x = age), binwidth=2, color="red") +
...
ggplot() +
  geom_freqpoly(data = data_client_age_by_issued_date, mapping = aes(x = age_on_card_issue), binwidth=1, color="blue") +
